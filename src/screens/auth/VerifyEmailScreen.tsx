...
export default function VerifyEmailScreen({ navigation }: Props) {
  return (
    <SafeAreaView className="flex-1 bg-background items-center justify-center px-6">
      ...
      <Text className="font-bold text-2xl text-foreground mb-2 text-center">Check your email</Text>
      ...
      <Button onPress={() => navigation.navigate('EmailVerified')}>Open Email App</Button>
