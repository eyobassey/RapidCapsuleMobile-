    ...
    >
      ...
      <View style={{ flexDirection: 'row', gap: 8 }}>
        {item.mood_score != null && (
          <MetricPill
            icon={<SmilePlus size={12} color={colors.primary} />}
            label="Mood"
            value={`${item.mood_score}/10`}
          />
        )}
        {item.craving_intensity != null && (
          <MetricPill
            ...
            label="Craving"
            value={`${item.craving_intensity}/10`}
          />
        )}
        {item.anxiety_level != null && (
          <MetricPill
            icon={<Brain size={12} color="#8b5cf6" />}
            label="Anxiety"
            value={`${item.anxiety_level}/10`}
          />
        )}
      </View>
