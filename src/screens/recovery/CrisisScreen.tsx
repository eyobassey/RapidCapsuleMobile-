...
export default function CrisisScreen() {
  ...
  const handlePanicButton = () => {
    Alert.alert(
      'Emergency Alert',
      'This will notify your care team immediately. Are you sure?',
      [
        {text: 'Cancel', style: 'cancel'},
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Alert.alert(
                'Alert Sent',
                'Your care team has been notified. Help is on the way.',
              );
            } catch {
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: colors.background}} edges={['top']}>
      ...
      <ScrollView
        ...
        <TouchableOpacity
          ...
          <View style={{flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: showGrounding ? 14 : 0}}>
            <View
              style={{
                width: 40,
                height: 40,
        ...
        <View
          ...
          <Text style={{flex: 1, fontSize: 13, color: colors.foreground, fontWeight: '500', lineHeight: 20}}>
