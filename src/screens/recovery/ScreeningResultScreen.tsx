  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={['top']}>
      ...
      >
        ...
        {ai ? (
          ...
          >
            ...
            {ai.recommended_interventions?.length > 0 && (
              <View style={{ gap: 4 }}>
                ...
                {ai.recommended_interventions.map((item: string, i: number) => (
                  <Text
                    key={i}
                    style={{ fontSize: 12, color: colors.mutedForeground, lineHeight: 18 }}
                  >
                    {'\u2022'} {item}
                  </Text>
                ))}
            ...
            {ai.motivational_message && (
              ...
              >
                <Text
                  style={{ fontSize: 12, color: colors.success, lineHeight: 18, fontWeight: '500' }}
                >
                  {ai.motivational_message}
                </Text>
              </View>
        ...
        {/* Actions */}
        <View style={{ gap: 10 }}>
          <Button variant="primary" onPress={() => navigation.navigate('RecoveryDashboard')}>
            Back to Dashboard
          </Button>
          <Button variant="outline" onPress={() => navigation.navigate('ScreeningHistory')}>
            View History
          </Button>
        </View>
      </ScrollView>
