...
import { UserCheck, Star, MessageSquare, Send, Clock, SmilePlus } from 'lucide-react-native';
...
export default function PeerSupportScreen() {
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={['top']}>
        ...
        >
          ...
          >
            Peer support pairs you with someone on a similar recovery journey. Your care team will
            set this up when appropriate.
          </Text>
        </ScrollView>
      </SafeAreaView>
    );
  ...
  const peerName = peerProfile ? `${peerProfile.first_name} ${peerProfile.last_name}` : 'Your Peer';
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={['top']}>
      ...
      >
        ...
        >
          ...
          <Text
            style={{ fontSize: 18, fontWeight: '700', color: colors.foreground, marginTop: 10 }}
          >
            {peerName}
          </Text>
