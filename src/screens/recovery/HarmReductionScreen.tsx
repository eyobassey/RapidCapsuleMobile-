      ...
      >
        ...
        >
          ...
          <Text style={{ flex: 1, fontSize: 12, color: colors.mutedForeground, lineHeight: 18 }}>
            Harm reduction provides practical strategies to reduce risks. This information does not
    ...
    <View>
      ...
      {items.map((item, i) => (
        <View key={i} style={{ flexDirection: 'row', gap: 8, marginBottom: 4 }}>
          <View
            style={{ width: 5, height: 5, borderRadius: 3, backgroundColor: color, marginTop: 6 }}
          />
          <Text style={{ flex: 1, fontSize: 12, color: colors.mutedForeground, lineHeight: 18 }}>
            {item}
          </Text>
